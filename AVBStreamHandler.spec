...
export LANG=C
export SOURCE_DATE_EPOCH=1555089990
mkdir -p clr-build
pushd clr-build
...
cp LICENSE_BOOST.txt %{buildroot}/usr/share/package-licenses/AVBStreamHandler/LICENSE_BOOST.txt
...
rm %{buildroot}/usr/lib64/libias-audio-common.so.4.0.0
## install_append end
...
%files bin
%defattr(-,root,root,-)
/usr/bin/avb_streamhandler_app_socket
...
/usr/share/package-licenses/AVBStreamHandler/LICENSE_BOOST.txt
